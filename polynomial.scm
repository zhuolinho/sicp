...
(define (install-polynomial-package)
    ...
    (define (reduce-poly p1 p2)
        (define (make terms)
            (tag (make-poly (variable p1) terms)))
        (if (same-variable? (variable p1) (variable p2))
            (map make
...
(define p1 (make-polynomial 'x (list (list 1 (make-scheme-number 1)) (list 0 (make-scheme-number 1)))))
(define p2 (make-polynomial 'x (list (list 3 (make-scheme-number 1)) (list 0 (make-scheme-number -1)))))
(define p3 (make-polynomial 'x (list (list 1 (make-scheme-number 1)))))
(define p4 (make-polynomial 'x (list (list 2 (make-scheme-number 1)) (list 0 (make-scheme-number -1)))))
